...
final class Slika_Kontroler extends Master_Kontroler {
    ...
    public function malaSlika (string $kontroler = '', string $metoda = '', string $slika = ''):Slika_Interface {
        ...
        return (new Slika())->slika(FIREHUB_ROOT.'web'.RAZDJELNIK_MAPE.'kapriol'.RAZDJELNIK_MAPE.'resursi'.RAZDJELNIK_MAPE.'grafika'.RAZDJELNIK_MAPE.'artikli'.RAZDJELNIK_MAPE.$slika)->dimenzije(400, 400)->napravi();
    ...
    public function usluga (string $kontroler = '', string $metoda = '', string $slika = ''):Slika_Interface {
        ...
        return (new Slika())->slika(FIREHUB_ROOT.'web'.RAZDJELNIK_MAPE.'kapriol'.RAZDJELNIK_MAPE.'resursi'.RAZDJELNIK_MAPE.'grafika'.RAZDJELNIK_MAPE.'reklame'.RAZDJELNIK_MAPE.$slika)->kvaliteta(90)->dimenzije(300, 1400)->napravi();
