...
final class Servis_Kontejner extends Kontejner {
    ...
    private function servis ():string {
        ...
        // provjeri da li postoji poslužitelj i zadani servis u konfiguraciji poslužitelja
    ...
    /**
     * ### Konfiguracijska datoteka posluzitelja
     *
     * Ulazna točka za konfiguraciju svih posluzitelja koja sadrži
     * niz FQN naziva Servis Poslužitelja.
     * @since 0.3.0.pre-alpha.M3
     *
     * @throws Kontejner_Greska Ukoliko se ne može učitati datoteka sa posluziteljima.
     *
     * @return array<string, array<string[]>> Konfiguracijska datoteka posluzitelja.
     */
    private function posluzitelji ():array {

        return include self::POSLUZITELJI ?? throw new Kontejner_Greska(_('Ne mogu pokrenuti sustav, obratite se administratoru'));
